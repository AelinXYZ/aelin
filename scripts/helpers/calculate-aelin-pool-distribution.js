...
async function main() {
	...
	for (let i = 0; i < accepted.length; i++) {
		if (openRedemptionPeriodTxsToRemove.includes(accepted[i].id.split('-')[0].toLowerCase())) {
	...
	sortedAelinFinalObject[sortedAelinFinal[sortedAelinFinal.length - 1].address] +=
		EXTRA_FROM_ROUNDING;
