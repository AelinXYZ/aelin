...
contract CurveVestAMM {
    ...
    function getPoolData(
        ...
        // NOTE NEED SOME LOGIC IN HERE TO HANDLE WHEN ONE OF THE TOKENS IS ETH
    ...
    function getEstimatedVirtualPriceDelta(
        ...
        //First Pool data should already have been determined when liquidity deposited was deposited
