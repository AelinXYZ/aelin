...
contract AelinPoolTest is Test, AelinTestUtils {
    ...
    //Revert scenarios
    function test_Initialize_RevertWhen_InitiatedTwice(
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_NotInPurchaseWindow(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_HasNoNftList(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_CollectionNotInPool(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    // FLAKY TEST
    function test_PurchasePoolTokensWithNft_RevertWhen_WalletAlreadyUsed(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_PurchaseMoreThanAllocation(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_CapExceeded(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_NotERC721Owner(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    // FLAKY TEST
    function test_PurchasePoolTokensWithNft_RevertWhen_ERC720TokenIdAlreadyUsed(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_ERC1155TokenIdNotInPool(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_ERC1155BalanceTooLow(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _purchaseDuration,
        uint256 _purchaseTokenAmount,
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_NotPunkOwner(
        uint256 _purchaseTokenCap,
        uint256 _purchaseTokenAmount,
        uint256 _minTokensEligible
    ) public {
    ...
    function test_PurchasePoolTokensWithNft_RevertWhen_PunkTokenIdAlreadyUsed(
        uint256 _purchaseTokenCap,
        uint256 _purchaseTokenAmount,
        uint256 _minTokensEligible
    ) public {
    ...
    function test_PurchasePoolTokensWithNft_PoolERC721(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
    ...
    function test_PurchasePoolTokensWithNft_PoolPunks(
        uint256 _purchaseTokenCap,
        uint256 _purchaseTokenAmount,
        uint256 _minTokensEligible
    ) public {
    ...
    function test_PurchasePoolTokensWithNft_PoolERC721AndPunks(uint256 _purchaseTokenCap, uint256 _purchaseTokenAmount)
        public
    {
    ...
    function test_PurchasePoolTokensWithNft_PoolERC1155(
        uint256 _purchaseTokenCap,
        uint256 _poolDuration,
        uint256 _sponsorFee,
        uint256 _purchaseDuration,
