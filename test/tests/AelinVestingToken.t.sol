...
contract AelinVestingTokenTest is Test, AelinTestUtils {
    ...
    function mintTokens(
        ...
        vestingToken.mintVestingToken(user1, _amount1, _timestamp1, 0);
        vestingToken.mintVestingToken(user2, _amount2, _timestamp2, 0);
        vestingToken.mintVestingToken(user3, _amount3, _timestamp3, 0);
    }
    ...
    function test_TransferVestingShare(
        ...
        emit VestingTokenMinted(_to, prevTokenCount, _shareAmount, lastClaimedAt, 0);
        vestingToken.transferVestingShare(_to, _tokenId, _shareAmount);
        vm.stopPrank();
